...
export const GenerateConfigSchema = z.object({
  ...
  variants: z.array(VariantSchema).default([
    ...
    { name: "simplicity", guidance: "Prioritize minimalism. Find the smallest scope that addresses the core problem." },
    { name: "depth", guidance: "Go deep on implementation specifics. Include exact commands, config snippets, error handling." },
    { name: "breadth", guidance: "Take a wide view. Consider alternatives, trade-offs, and second-order effects." },
  ]),
...
export const MergeStrategySchema = z.enum(["simple", "agent-teams", "subagent-debate"]);
